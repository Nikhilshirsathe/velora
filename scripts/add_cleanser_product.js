...
async function main() {
  const product = await prisma.product.create({
    data: {
      ...
      description: 'Gentle facial cleanser with Dead Sea minerals and natural extracts',
      price: 160,
      image: 'https://i.ibb.co/67Kd23SQ/Whats-App-Image-2025-09-15-at-8-15-31-PM.jpg',
